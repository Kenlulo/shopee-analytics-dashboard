...
st.markdown(f"<p style='font-size: 15px; margin-top: -5px; padding-left: 15px;'>👉 {t('Nếu bạn muốn xem thêm dự án khác hãy')} <a href='https://hoanhkhoa.vercel.app' target='_blank' style='text-decoration: underline; color: #1f77b4;'>{t('nhấp vào đây')}</a></p>", unsafe_allow_html=True)
    ...
    try:
        ...
        with col2:
            ...
            st.markdown(
                ...
                f"👨‍💻 <b>{t('Phát triển bởi Hồ Anh Khoa')}</b> <br> <a href='https://hoanhkhoa.vercel.app' target='_blank' style='color:#16A085; text-decoration:none; font-weight:700;'>👉 {t('Nhấp vào đây để xem thêm các dự án Portfolio khác')}</a>"
                f"</p>", 
                unsafe_allow_html=True
            )
